...
{
    if (en) {
        palSetPad(GPIOC, GPIOC_RESISTOR_1);
    } else {
        palClearPad(GPIOC, GPIOC_RESISTOR_1);
    }
}
...
{
    if (en) {
        palSetPad(GPIOC, GPIOC_RESISTOR_2);
    } else {
        palClearPad(GPIOC, GPIOC_RESISTOR_2);
    }
}
...
{
    if (en) {
        palSetPad(GPIOC, GPIOC_RESISTOR_3);
    } else {
        palClearPad(GPIOC, GPIOC_RESISTOR_3);
    }
}
...
{
    if (en) {
        palSetPad(GPIOA, GPIOA_RESISTOR_4);
    } else {
        palClearPad(GPIOA, GPIOA_RESISTOR_4);
    }
}
